...
@interface Rak_Lx52x_Remote_Connect : NSObject
///*
+(void)NabtoLogStart;
+(void)NabtoLogStop;
+(void)SaveNabtoLog:(NSString*)ErrNabtoID;
//*/

/**
 * Init nabto library.
 */
+(int)NabtoLibraryInit;
/**
 ...
 */
+(nabto_tunnel_state_t)Sync_ConnectDeviceWithTunnel:(nabto_tunnel_t*)tunnel andId:(NSString *)RemoteId andRemotePort:(int)RemotePort andLocalPort:(int)LocalPort andTime:(float)times;
/**
 * Opens a TCP tunnel to a remote server through a Nabto enabled device。
 ...
 */
+(nabto_status_t)Async_ConnectDeviceWithTunnel:(nabto_tunnel_t*)tunnel andId:(NSString *)RemoteId andRemotePort:(int)RemotePort andLocalPort:(int)LocalPort;
/**
